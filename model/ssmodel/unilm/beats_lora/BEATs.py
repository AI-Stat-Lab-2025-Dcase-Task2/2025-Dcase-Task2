...
from model.ssmodel.unilm.beats.backbone import (
    TransformerEncoder,
)
...
class BEATs(nn.Module):
    ...
    def spectrogram_augment(self, spec):
        freq_masking = torchaudio.transforms.FrequencyMasking(80, iid_masks=True)
        time_masking = torchaudio.transforms.TimeMasking(80, iid_masks=True)
    ...
    def extract_features(
        ...
        if spec_aug:
            fbank = self.spectrogram_augment(fbank)
